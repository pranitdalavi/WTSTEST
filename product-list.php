                                    ...
                                    <div class=" mb-0" style="padding: 0 !important;border-radius:0px;">
                                        ...
                                        <a class="prod-list-link" href="<?= DOMAIN ?>/<?= $slug ?>/<?= $row->seo_url ?>">
                                            ...
                                            <p style="padding-left: 5px;font-size: 24px;" class="orange text-left">
                                                ...
                                                <i style="font-size:24px; color:<?php if($row->wishlist==1 ){ echo "red"; }else{ echo "#ccc"; } ?>" class="fa fa-heart wishlist-heart" id="<?php echo $row->seo_url ?>"  onclick="preventRedirection()"></i>
                                            </p>
                                            <div class="">
                                                <?php
