...
class ProductsFromOrder extends ObjectModel
{
    ...
    protected $fillable = ['order_id', 'product_id', 'quantity', 'price', 'title', 'discount', 'options', 'sku','extra', 'customerSourceOrder'];
	...
	foreach( $this->cart->getAll() as $cart_row ){
		...
		$this->sku = $cart_row->product_sku;
		$this->extra = $cart_row->extra;
