...
class DimensionImage extends ObjectModel
{

    protected $table = 'dimension_images';
    ...
    public function getAll($blog_id = null)
    {
        ...
        return $this->execute('SELECT * FROM dimension_images WHERE blog_id = ? AND deleted_at IS NULL ORDER BY id ASC ', [ $blog_id ] );
    }
